          ...
          {weeklyData.length > 0 ? (
            <ResponsiveContainer width="100%" height={280}>
              <AreaChart data={weeklyData}>
                ...
                <XAxis dataKey="day" stroke="hsl(220, 10%, 46%)" fontSize={12} axisLine={{ stroke: "hsl(22, 93%, 49%)", strokeWidth: 1.5 }} tickLine={false} /><YAxis stroke="hsl(220, 10%, 46%)" fontSize={12} axisLine={{ stroke: "hsl(22, 93%, 49%)", strokeWidth: 1.5 }} tickLine={false} />
